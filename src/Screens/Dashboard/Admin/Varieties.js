...
function Varieties1() {
  ...
  // تعديل بيانات الأصناف لتشمل المسار الصحيح للصور
  const VarietiesWithCorrectPaths = Varieties.map((variety) => ({
    ...variety,
    image: `${process.env.PUBLIC_URL}/images/varieties/${variety.image}`,
  }));
  ...
  return (
    <SideBar>
      ...
      <CreateVarieties
        ...
        name={VarietiesWithCorrectPaths}
      />
      ...
      <div className="flex flex-col gap-6">
        ...
        {/* Table */}
        <Table4
          data={VarietiesWithCorrectPaths}
          users={false}
